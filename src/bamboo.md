...
[I said 300 kb, didn't I.](#2016722-report-kinoko) I lied.
...
For example, the Servants that would appear in all seven chapters of the main story, and the [event where the titles of all seven chapters were presented](https://www.youtube.com/watch?v=rUNxqTsdmsE) were already set back then (2014 UBW).
...
:::tip Note
Read the three links below for context for this fever dream of a diary entry.
...
Of course, the longsword is supreme. An all-purpose weapon that can deal with any situation. That it's plain-looking is but a fly in the ointment.  
